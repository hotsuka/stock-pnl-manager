...
class BenchmarkPrice(db.Model):
    ...
    benchmark_key = db.Column(db.String(10), nullable=False, index=True)  # 'TOPIX', 'SP500'
    ...
    __table_args__ = (db.UniqueConstraint("benchmark_key", "price_date", name="uix_benchmark_date"),)
