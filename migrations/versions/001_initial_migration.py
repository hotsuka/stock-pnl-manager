...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "settlement_amount", sa.Numeric(precision=15, scale=4), nullable=True
        ),
    ...
    op.create_index(
        "ix_transactions_ticker_symbol", "transactions", ["ticker_symbol"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "unrealized_pnl_pct", sa.Numeric(precision=10, scale=4), nullable=True
        ),
    ...
    op.create_index(
        "ix_holdings_ticker_symbol", "holdings", ["ticker_symbol"], unique=False
    )
    ...
    op.create_index(
        "ix_dividends_ex_dividend_date", "dividends", ["ex_dividend_date"], unique=False
    )
    op.create_index(
        "ix_dividends_ticker_symbol", "dividends", ["ticker_symbol"], unique=False
    )
    ...
    op.create_index(
        "ix_stock_prices_price_date", "stock_prices", ["price_date"], unique=False
    )
    op.create_index(
        "ix_stock_prices_ticker_symbol", "stock_prices", ["ticker_symbol"], unique=False
    )
    ...
    op.create_index(
        "ix_realized_pnl_sell_date", "realized_pnl", ["sell_date"], unique=False
    )
    op.create_index(
        "ix_realized_pnl_ticker_symbol", "realized_pnl", ["ticker_symbol"], unique=False
    )
    ...
    op.create_index(
        "ix_stock_metrics_ticker_symbol",
        "stock_metrics",
        ["ticker_symbol"],
        unique=False,
    )
